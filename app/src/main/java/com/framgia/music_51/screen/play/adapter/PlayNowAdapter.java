package com.framgia.music_51.screen.play.adapter;
    ...
    static class DetailViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        private void bindData(List<Track> tracks, Track track, int position) {
            ...
            if (track.getArtworkUrl() != null) {
                ...
                Glide.with(mContext).load(R.drawable.image_default).into(mImageTrack);
            }
            if (track.getPublisherMetadata() == null) {
                mTextAuthor.setText("Unknown");
            } else {
                mTextAuthor.setText(track.getPublisherMetadata().getArtist());
            }
